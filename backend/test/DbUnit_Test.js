...
describe('Db Unit Controller', () => {
    //test that the correct unit is returned for a given unit id
    //test that a given unit id does not return an incorrect unit
    describe('getUnit()', () => {
    ...
    //test that the correct unit is returned for a given staff id
    //test that a given unit id does not return an incorrect staff id
